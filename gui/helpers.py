...
**Example Input**:
- Diagnosis Text: I10 - Essential (primary) hypertension^^^^^^E119 - Type 2 diabetes mellitus without complications^^^^^^E785 - Hyperlipidemia, unspecified
- Symptoms Text: U/L DM HPT dyslipidemia h/o hepatitis A in 2022 currently: t losartan 100mg od t atorvastatin 40mg on t aspirin 100mg od t gliclazide 80mg od t metformin 1g bd no active complaints BP DXT well controlled
- Prescription Text: 273 | Losartan 50mg Tablet | UoM: TABLET | ^^^^^^281 | Metformin 500mg Tablet | UoM: TABLET | ^^^^^^258 | Gliclazide 80mg Tablet | UoM: TABLET | ^^^^^^206 | Atorvastatin 20mg Tablet | UoM: TABLET | ^^^^^^191 | Acetylsalicylic Acid 100mg Tablet (Aspirin) | UoM: TABLET |
...
def generate_summary(diagnosis_text, symptoms_text, prescription_text):
    contents = [
        types.Part.from_text(text=f"Diagnosis Text: {diagnosis_text}\nSymptoms Text: {symptoms_text}\nPrescription Text: {prescription_text}"),
    ]
...
def generate_tags(diagnosis_text, symptoms_text, prescription_text):
    ...
    url = 'http://127.0.0.1:8080/ctakes-web-rest/service/analyze'
